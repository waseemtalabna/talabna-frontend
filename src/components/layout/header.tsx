...
export const Header: React.FC = () => {
  ...
  return (
    <header className="bg-white sticky top-0 z-50 shadow-lg">
        <div className="container flex h-full w-full items-center justify-between px-2 md:px-0">
            {/*<div className="flex-col">*/}
            {/*    <img src="/images/logo.png" alt="logo" className="w-3/6" />*/}
            {/*</div>*/}
            ...
            <nav className="bg-white fixed w-full z-20 top-0 start-0 border-b border-gray-200">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        <button type="button" className="text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center  "> Register</button>
